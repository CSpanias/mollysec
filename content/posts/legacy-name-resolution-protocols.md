...
**Note**: Changes to name resolution behaviour should be carefully tested before deployment. Disabling certain protocols, particularly mDNS, can introduce unexpected operational issues, such as broken printer discovery or loss of screen sharing and casting functionality in conferencing environments.